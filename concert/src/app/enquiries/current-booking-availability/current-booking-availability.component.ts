...
export class CurrentBookingAvailabilityComponent implements OnInit {
  ...
  fetchedAccomodationAvailability: any = [
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'NOT DONE', cur_bkg_status: 'NO', days_running: '', classes: ''},
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'DONE', cur_bkg_status: 'YES', days_running: '', classes: ''},
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'NOT DONE', cur_bkg_status: 'NO', days_running: '', classes: ''},
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'DONE', cur_bkg_status: 'YES', days_running: '', classes: ''},
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'NOT DONE', cur_bkg_status: 'YES', days_running: '', classes: ''},
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'NOT DONE', cur_bkg_status: 'YES', days_running: '', classes: ''},
    {train_no: '12560', train_name: 'ANVT BUI SF EXP', src: 'NDLS', dep: '09:25', dest: 'BUI', arr: '00:30',
     chart_status: 'NOT DONE', cur_bkg_status: 'YES', days_running: '', classes: ''},
