...
@Component({
  selector: 'app-charting-status',
  templateUrl: './charting-status.component.html',
  styleUrls: ['./charting-status.component.scss']
})
export class ChartingStatusComponent implements OnInit {
  ...
  fetchedAccomodationAvailability: any = [
    {stn_Code: 'NDLS', stn_Name: 'New Delhi', arrival_Time: 'Source', departure_Time: '18:55', distance: '0', chart: 'PREPARED', day: '1' },
    {stn_Code: 'CNB', stn_Name: 'New Delhi', arrival_Time: '00:40',
      departure_Time: '00:55', distance: '440', chart: 'NOT PREPARED', day: '2' },
    {stn_Code: 'ALD', stn_Name: 'New Delhi', arrival_Time: '03:20',
     departure_Time: '03:45', distance: '634', chart: 'NOT PREPARED', day: '2' },
  ];
