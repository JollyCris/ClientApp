...
@Component({
  selector: 'app-search-for-pnr',
  templateUrl: './search-for-pnr.component.html',
  styleUrls: ['./search-for-pnr.component.scss']
})
export class SearchForPnrComponent implements OnInit {
