...
@Component({
  selector: 'app-passengers-cancelled-after-charting',
  templateUrl: './passengers-cancelled-after-charting.component.html',
  styleUrls: ['./passengers-cancelled-after-charting.component.scss']
})
export class PassengersCancelledAfterChartingComponent implements OnInit {
